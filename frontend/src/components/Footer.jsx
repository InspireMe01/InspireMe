...
return (
    <div>
        <div className="flex flex-col sm:grid grid-cols-[1.5fr_1fr] sm:gap-14 gap-8 my-10 sm:mt-40 mt-20 text-sm items-center sm:items-start text-center sm:text-left">
            <div>
            ...
            <div className="flex flex-row gap-14 sm:grid grid-cols-2">
                <div>
